...
export async function getConfigurationApp(){
  ...
  try {
    ...
    let response = await fetch(urlApi + "/configuracion-app",
    {
      method: 'GET',
    ...
    // this.urlApiImagenes = config.endpointimagenes;

  } catch(e) {
    console.error('Error getting citian data with api: ', e)
  }
...
/**
 * get projects from initial state from API
 * @param {*} categoria
 * @param {string} [nombre=""]
 * @param {*} latitud
 * @param {*} longitud
